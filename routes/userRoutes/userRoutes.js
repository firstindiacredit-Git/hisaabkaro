...
// Route for updating PIN (protected)
router.patch("/update-pin/:userId", authenticate, updatePin);

// Route for verifying PIN (protected)
router.post("/verify-pin/:userId", authenticate, verifyPin);
