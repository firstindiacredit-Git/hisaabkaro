...
const createNotification = async (notificationData) => {
  try {
    ...
    // Get recipient details - try both User and ClientUser models
    let recipient = await User.findById(notificationData.recipient);
    let recipientModel = "User";

    if (!recipient) {
      recipient = await ClientUser.findById(notificationData.recipient);
      recipientModel = "ClientUser";
    }
